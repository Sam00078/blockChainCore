...
function defineTransaction () {
  ...
  function encodingLength (obj) {
    ...
    if (defined(obj.type == 0)) {

      var len = enc[0].encodingLength(obj)
      length += varint.encodingLength(len)
      length += 1 + len
    }
    if (defined(obj.type == 1)) {
      var len = enc[1].encodingLength(obj)
      length += varint.encodingLength(len)
      length += 1 + len
    }
    return length
  ...
  function encode (obj, buf, offset) {
    ...
    if (obj.type == 0) {
      buf[offset++] = 10
      varint.encode(enc[0].encodingLength(obj), buf, offset)
      offset += varint.encode.bytes
      enc[0].encode(obj, buf, offset)
      offset += enc[0].encode.bytes
    }
    if (obj.type == 1) {
      buf[offset++] = 18
      varint.encode(enc[1].encodingLength(obj), buf, offset)
      offset += varint.encode.bytes
      enc[1].encode(obj, buf, offset)
      offset += enc[1].encode.bytes
    }
    encode.bytes = offset - oldOffset
    return buf
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        var len = varint.decode(buf, offset)
        offset += varint.decode.bytes
        obj = enc[0].decode(buf, offset, offset + len)
        offset += enc[0].decode.bytes
        break
        case 6:
        ...
        var len = varint.decode(buf, offset)
        offset += varint.decode.bytes
        obj = enc[1].decode(buf, offset, offset + len)
        offset += enc[1].decode.bytes
        break
        default:
        offset = skip(prefix & 7, buf, offset)
