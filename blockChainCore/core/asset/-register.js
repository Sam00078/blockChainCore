...
module.exports = app => {
    ...
    app.core.bcc.asset = Object.assign(app.core.bcc.asset, {
         ...
         * 注册资产处理类
         */
        async registerTypeHandle ( kind_num, kind_def_name, paramate_properties, handle_class ) {
            return app.core.bcc.help.returnAmtRunFlowPromise(this, 'assetRegisterTypeHandle', {}, {kind_num, kind_def_name, paramate_properties, handle_class})
        },
    ...
    app.core.bcc.asset.amt.it( CONSTANTS.amtfns.assetRegisterTypeHandle, {
        ...
        // kind_num, kind_def_name, paramate_properties, handle_class

        // 数据字段格式定义
        const paramate_item = {
            type: '{}',
            properties: argv.paramate_properties,
            fixed: argv.kind_num,
        }
        app.core.bcc.paramate.definition('Asset<kind>', paramate_item, {
        ...
        handle.setParamate(paramate_item)
